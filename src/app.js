...
const dropoutRouter = require("./routes/auth/dropout");
...
const todayTopicBoardRouter = require("./routes/board/todayTopicBoard");
...
app.use("/auth", verifyToken, dropoutRouter);
...
app.use("/board/topic", verifyToken, todayTopicBoardRouter);
